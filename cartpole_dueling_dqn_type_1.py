...
for seed in seeds:
    ...
    agent = DDQNAgent(device, replay_buffer, local_network, target_nework, cartpole_optimizer, algo_type="type_1")
...
with open('cartpole_dueling_dqn_type_1_reward_statistics.txt', 'w') as file:
...
plt.savefig('cartpole_dueling_dqn_type_1.png')
plt.show()