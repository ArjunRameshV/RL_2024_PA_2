...
for seed in seeds:
    ...
    agent = REINFORCEAgent(device, cartpole_policy, cartpole_optimizer)
...
with open('cartpole_reinforce_type_1_reward_statistics.txt', 'w') as file:
...
plt.savefig('cartpole_reinforce_type_1.png')
plt.show()